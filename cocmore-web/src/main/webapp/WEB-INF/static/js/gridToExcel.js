            ...
            for (var j = 0; j < colCount; j++) {
                if ((cm.getDataIndex(j) != '')
                    ...
                    if (cellType[k] !== "None") {
                    	...
                    	if(cm.getDataIndex(j) == 'yBasicOrganization'){
                    		v = v.fname;
                    	}else if(cm.getDataIndex(j) == 'fbillState'){
                    		if(v == 0){
                        		v= '新增';
                        	}else if(v == 1){
                        		v= '保存';
                    	...
                    	}else if(cm.getDataIndex(j)=='forginalCurrency' || cm.getDataIndex(j)=='fobjectiveCurrency'){
                    		v = v.fcurrencyName;
                    	}else if(cm.getDataIndex(j)=='ywallactivity'){
                    		v = v.ftheme;
                    	}
