...
<head>
	...
	<script type="text/javascript" src=" ../static/jquery/jquery.qrcode.js"></script>
	<script type="text/javascript" src=" ../static/jquery/qrcode.js"></script>
	<script type="text/javascript" src=" ../static/js/zthd.js"></script>
</head>
	<body>
		<div id="mainDiv"></div>
	</body>
