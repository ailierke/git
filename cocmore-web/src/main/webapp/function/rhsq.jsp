...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="IE=Edge">content="IE=EmulateIE7" />
	<title>云筑圈管理系统V1.0-入会申请</title>
	...
	<script src=" ../static/js/DecryptByABC.js"  type="text/javascript"></script>
	<script type="text/javascript" src=" ../static/js/rhsq.js"></script>
</head>
	<body>
		<div id="mainDiv"></div>
	</body>
