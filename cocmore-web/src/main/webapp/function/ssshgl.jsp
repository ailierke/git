...
<head>
	...
	<title>云筑圈管理系统V1.0-实时生活管理</title>
	...
	<script type="text/javascript" src=" ../static/js/ssshgl.js"></script>
	<link href="../static/webApp/shxmxq.css" type="text/css" rel="stylesheet"/>
